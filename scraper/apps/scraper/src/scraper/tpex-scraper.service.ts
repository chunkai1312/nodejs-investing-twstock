...
export class TpexScraperService {
  ...
  async fetchIndicesTrades(options?: { date: string }) {
    ...
    const sectorMappings = {
      '光電業': { symbol: 'IX0055', name: '櫃檯光電業類指數' },
      '其他': { symbol: 'IX0100', name: '櫃檯其他類指數' },
      '其他電子業': { symbol: 'IX0099', name: '櫃檯其他電子類指數' },
      '化學工業': { symbol: 'IX0051', name: '櫃檯化工類指數' },
      '半導體業': { symbol: 'IX0053', name: '櫃檯半導體類指數' },
      '建材營造': { symbol: 'IX0048', name: '櫃檯營建類指數' },
      '文化創意業': { symbol: 'IX0075', name: '櫃檯文化創意業類指數' },
      '生技醫療': { symbol: 'IX0052', name: '櫃檯生技醫療類指數' },
      '紡織纖維': { symbol: 'IX0044', name: '櫃檯紡纖類指數' },
      '航運業': { symbol: 'IX0049', name: '櫃檯航運類指數' },
      '觀光事業': { symbol: 'IX0050', name: '櫃檯觀光類指數' },
      '資訊服務業': { symbol: 'IX0059', name: '櫃檯資訊服務類指數' },
      '通信網路業': { symbol: 'IX0056', name: '櫃檯通信網路類指數' },
      '鋼鐵工業': { symbol: 'IX0046', name: '櫃檯鋼鐵類指數' },
      '電子通路業': { symbol: 'IX0058', name: '櫃檯電子通路類指數' },
      '電子零組件業': { symbol: 'IX0057', name: '櫃檯電子零組件類指數' },
      '電機機械': { symbol: 'IX0045', name: '櫃檯機械類指數' },
      '電腦及週邊設備業': { symbol: 'IX0054', name: '櫃檯電腦及週邊類指數' },
    };
